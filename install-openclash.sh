...
#下载安装包
wget https://www.dropbox.com/scl/fi/h869ac1nb7gn29tq3ah6p/openwrt-buddah-version-v1-2024-squashfs-uefi.img.gz
...
#复制x-wrt固件到根目录并改名
cp openwrt-buddah-version-v1-2024-squashfs-uefi.img.gz /x-wrt.img.gz
