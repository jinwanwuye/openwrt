...
#下载安装包
wget https://github.com/jinwanwuye/openwrt/raw/main/x-wrt-x86-64-generic-ext4-combined-efi.img.gz

#下载内核执行脚本
wget https://raw.githubusercontent.com/jinwanwuye/openwrt/main/vda2/x-wrt-install-vps.sh
...
#复制x-wrt固件到根目录并改名
cp x-wrt-x86-64-generic-ext4-combined-efi.img.gz /boot/x-wrt.img.gz
