...
#下载安装包
wget https://github.com/jinwanwuye/openwrt/raw/main/immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz
...
#复制x-wrt固件到根目录并改名
cp immortalwrt-x86-64-generic-squashfs-combined-efi.img.gz /boot/x-wrt.img.gz
